  ...
  return (
    <header className="bg-white relative px-4">
      <div className="container mx-auto relative py-4 flex justify-between gap-4 items-center bg-white">
        ...
        <nav className={`flex flex-col md:flex-row md:gap-4 md:justify-center absolute md:static ${navShow ? 'left-0' : 'left-[100vw]'} top-full w-full bg-orange-100 md:bg-transparent z-50`}>
          {
        ...
        <div className="flex gap-3 items-center">
          <Link to={"/cart"} className="flex p-1.5 border border-gray-50 hover:bg-orange-50 rounded-md cursor-pointer relative">
            <span className="absolute -top-2 -right-1 h-4 w-4 rounded-full text-white bg-orange-500 grid place-items-center text-xs">{cartState.length}</span>
